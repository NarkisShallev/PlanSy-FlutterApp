...
class BuildDurationTextFormFieldForCreate extends StatefulWidget {
  final MaskTextInputFormatter formatter = MaskTextInputFormatter(mask: "##:##");
  final Function onSaved;
  final BuildContext context;
  final Function setDuration;

  BuildDurationTextFormFieldForCreate({this.onSaved, this.context, this.setDuration});

  @override
  _BuildDurationTextFormFieldForCreateState createState() =>
      _BuildDurationTextFormFieldForCreateState();
}

class _BuildDurationTextFormFieldForCreateState extends State<BuildDurationTextFormFieldForCreate> {
