...
class BuildClosingTimeFormFieldForCreate extends StatefulWidget {
  final MaskTextInputFormatter formatter = MaskTextInputFormatter(mask: "##:##");
  final Function onSaved;
  final BuildContext context;
  final Function setClosingTime;

  BuildClosingTimeFormFieldForCreate({this.onSaved, this.context, this.setClosingTime});

  @override
  _BuildClosingTimeFormFieldForCreateState createState() =>
      _BuildClosingTimeFormFieldForCreateState();
}

class _BuildClosingTimeFormFieldForCreateState extends State<BuildClosingTimeFormFieldForCreate> {
